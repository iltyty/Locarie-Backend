...
public interface PostRepository extends CrudRepository<PostEntity, Long> {
     ...
     *
     * <p>This method uses the provided latitude and longitude along with a distance parameter to
     * find posts nearby. The distance is measured in kilometers. It returns a list of PostEntity
     * objects that are located within a circular centered at the specified location with the given
