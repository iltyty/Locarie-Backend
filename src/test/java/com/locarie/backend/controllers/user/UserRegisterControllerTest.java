...
public class UserRegisterControllerTest {
    ...
    void testRegisterPlainUserShouldSucceed() throws Exception {
        ...
        MockMultipartHttpServletRequestBuilder request =
                givenUserRegisterRequest(userRegistrationDto);
    ...
    void testRegisterUserWithInvalidUsernameShouldFail() throws Exception {
        UserRegistrationDto userRegistrationDto =
                givenPlainUserRegistrationDtoWithInvalidUsername();
        MockMultipartHttpServletRequestBuilder request =
                givenUserRegisterRequest(userRegistrationDto);
        ResultActions resultActions = whenPerformUserRegisterRequest(request);
        thenRegisterResultStatusShouldBeBadRequest(resultActions);
    ...
    void testRegisterUserWithInvalidPasswordShouldFail() throws Exception {
        UserRegistrationDto userRegistrationDto =
                givenPlainUserRegistrationDtoWithInvalidPassword();
        MockMultipartHttpServletRequestBuilder request =
                givenUserRegisterRequest(userRegistrationDto);
        ResultActions resultActions = whenPerformUserRegisterRequest(request);
        thenRegisterResultStatusShouldBeBadRequest(resultActions);
    ...
    private static MockPart createUserPartInRegisterRequest(
            UserRegistrationDto userRegistrationDto) {
        try {
    ...
    private void thenRegisterResultShouldContainUser(ResultActions result, UserRegistrationDto dto)
        ...
        result.andExpect(UserControllerResultMatcherUtil.resultStatusCodeShouldBeSuccess())
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.data.type")
                                .value(dto.getType().toString()))
                .andExpect(
    ...
    private void thenRegisterResultShouldBeUserAlreadyExists(ResultActions result)
            throws Exception {
        result.andExpect(
                ...
                .andExpect(
                        MockMvcResultMatchers.jsonPath("$.message")
                                .value(ResultCode.RC201.getMessage()));
    }

    private void thenRegisterResultStatusShouldBeInvalidParameters(ResultActions result)
            throws Exception {
        result.andExpect(
                UserControllerResultMatcherUtil.resultStatusCodeShouldBeInvalidParameters());
    }

    private void thenRegisterResultMessageContainType(ResultActions resultActions)
            throws Exception {
    ...
    private void thenRegisterResultMessageContainUsername(ResultActions resultActions)
        ...
        resultActions.andExpect(
                UserControllerResultMatcherUtil.resultMessageShouldContainUsername());
    }

    private void thenRegisterResultMessageContainEmail(ResultActions resultActions)
            throws Exception {
    ...
    private void thenRegisterResultMessageContainPassword(ResultActions resultActions)
            throws Exception {
        resultActions.andExpect(
                UserControllerResultMatcherUtil.resultMessageShouldContainPassword());
    }
}
